...
window = Tk()
window.title("WinLocker by RiderMC")
...
txt_one = Label(window, text='WinLocker by RiderMC', font=("Arial Bold", fontsizeHding), fg='red', bg='black')
...
txt_three.place(relx = .01, rely = .15)
